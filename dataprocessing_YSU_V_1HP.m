% dataprocessing_YSU_V_1HP.m
% YSU_V 单负载 1HP: 多文件拼接 → 滑窗 → CWT → PCA (8→3) → RGB图 → 划分
...
%% ========== 路径配置 ==========
data_dir    = 'C:\Users\ClearNight\Desktop\YSU_V\1HP';
output_root = 'C:\Users\ClearNight\Desktop\PINN\CWT_PCA_1HP';
