% dataprocessing_YSU_V_2HP.m
% YSU_V 单负载 2HP: 多文件拼接 → 滑窗 → CWT → PCA (8→3) → RGB图 → 划分
...
%% ========== 路径配置 ==========
data_dir    = 'C:\Users\ClearNight\Desktop\YSU_V\2HP';
output_root = 'C:\Users\ClearNight\Desktop\PINN\CWT_PCA_2HP';
