...
%% ========== 路径 ==========
data_dir = 'C:\Users\ClearNight\Desktop\10series\CWRU1HP';
output_root = 'C:\Users\ClearNight\Desktop\PINN\CWT_1HPMatrices';   % 只存矩阵
...
if need_generate
    ...
    for k = 1:size(label_map, 1)
        ...
        file_id = filename(1:end-4);  % '98.mat' -> '98'
